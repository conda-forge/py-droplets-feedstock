...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/py-droplets-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/py-droplets-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add py-droplets
# for installing globally
pixi global install py-droplets
```
...
It is possible to list all of the versions of `py-droplets` available on your platform:
...
```
pixi search py-droplets --channel conda-forge
```
